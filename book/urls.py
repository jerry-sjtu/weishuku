...
urlpatterns = patterns('',
    ...
    url(r'^delbook/(?P<bookid>\d+)/$', views.del_book, name='delbook'),
    url(r'^delall/$', views.del_all, name='delall'),
    url(r'^recall/$', views.recover_all, name='recall'),
    url(r'^recbook/(?P<bookid>\d+)/$', views.recover_book, name='recbook'),
